...
describe('🛡️ Validadores Zod - Testes Unitários Críticos', () => {
  ...
  describe('esquemaCriacaoPerfume - Validação de Números', () => {
    ...
    it('deve REJEITAR preço negativo', () => {
      ...
      expect(() => esquemaCriacaoPerfume.parse(dadosInvalidos))
    ...
    it('deve REJEITAR frasco negativo', () => {
      ...
      expect(() => esquemaCriacaoPerfume.parse(dadosInvalidos))
        .toThrow('O volume deve ser maior que zero');
    });
  ...
  describe('esquemaEditarEstoque - Validação Crítica', () => {
    ...
    it('deve REJEITAR estoque negativo', () => {
      expect(() => esquemaEditarEstoque.parse({ quantidade_estoque: -5 }))
        .toThrow();
    });
    ...
    it('deve REJEITAR decimal (apenas inteiros)', () => {
      expect(() => esquemaEditarEstoque.parse({ quantidade_estoque: 10.7 }))
        .toThrow();
    });
  });
  ...
  describe('esquemaListagemPerfumes - Paginação', () => {
    ...
    it('deve REJEITAR page negativa', () => {
      expect(() => esquemaListagemPerfumes.parse({ page: -1 }))
        .toThrow('Página deve ser maior que zero');
    });

    it('deve REJEITAR page zero', () => {
      expect(() => esquemaListagemPerfumes.parse({ page: 0 }))
        .toThrow('Página deve ser maior que zero');
    });

    it('deve REJEITAR page decimal', () => {
      expect(() => esquemaListagemPerfumes.parse({ page: 1.5 }))
        .toThrow('Página deve ser um número inteiro');
    });
    ...
    it('deve REJEITAR limit negativo', () => {
      expect(() => esquemaListagemPerfumes.parse({ limit: -10 }))
        .toThrow('Limite deve ser maior que zero');
    });

    it('deve REJEITAR limit maior que 20', () => {
      expect(() => esquemaListagemPerfumes.parse({ limit: 21 }))
        .toThrow('Limite máximo é 100 itens por página');
    });
